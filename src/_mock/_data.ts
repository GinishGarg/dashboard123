...
export const _langs = [
  {
    value: 'en',
    label: 'English',
    icon: '/assets/icons/flags/icflagen.svg',
  },
  {
    value: 'de',
    label: 'German',
    icon: '/assets/icons/flags/icflagde.svg',
  },
  {
    value: 'fr',
    label: 'French',
    icon: '/assets/icons/flags/icflagfr.svg',
  },
];
...
export const _timeline = [...Array(5)].map((_, index) => ({
  ...
  title: [
    ...
    'New order placed #XF2356',
    'New order placed #XF2346',
  ][index],
  type: `order${index + 1}`,
  time: _times(index),
}));
